...
| Apellidos y Nombres               |  Legajo   | Usuario de GitHub |
| --------------------------------- | :-------: | :---------------: |
| Samudio, Dante Ezequiel           | 214.105–0 |     @SamDante     |
| Melitón Clemente, Genaro          | 213.006–3 |  @genaromeliton   |
| Gutiérrez Zevallos, José Leonardo | 212.988–7 |   @Leo-de-Riv3r   |
| Becerra, José Luis                | 204.675–1 |    @jbecerra0     |
| Polastri, Lucca                   | 214.015–9 |    @lpolastri     |

## Enunciado

[TP Integrador Anual DDSI 2025 - MetaMapa](https://docs.google.com/document/d/1ctxGwWrnM0XmPii38KWod9mTzphzNxxPRg9HkpXyNBg)
